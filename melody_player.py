...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.Button_00.setText("𝅘𝅥")
        self.Button_00.clicked.connect(lambda: winsound.Beep(2500, 100))
        ...
        self.Button_01.clicked.connect(lambda: winsound.Beep(2300, 100))
        ...
        self.Button_02.clicked.connect(lambda: winsound.Beep(2100, 100))
        ...
        self.Button_03.clicked.connect(lambda: winsound.Beep(1900, 100))
        ...
        self.Button_04.clicked.connect(lambda: winsound.Beep(1700, 100))
        ...
        self.Button_05.clicked.connect(lambda: winsound.Beep(1500, 100))
        ...
        self.Button_06.clicked.connect(lambda: winsound.Beep(1300, 100))
        ...
        self.Button_07.clicked.connect(lambda: winsound.Beep(1100, 100))
        ...
        self.Button_08.clicked.connect(lambda: winsound.Beep(900, 100))
        ...
        self.Button_09.clicked.connect(lambda: winsound.Beep(700, 100))
        ...
        self.Button_10.clicked.connect(lambda: winsound.Beep(500, 100))
        ...
        self.Button_11.clicked.connect(lambda: winsound.Beep(300, 100))
